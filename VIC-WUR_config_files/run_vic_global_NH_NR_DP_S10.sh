#!/bin/bash
#SBATCH --job-name=VIC_Global_NH_NR_DP_S10
#SBATCH --output=/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/VIC-WUR_config_files/logs/VIC_Global_NH_NR_DP_S10_%j.out
#SBATCH --error=/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/VIC-WUR_config_files/logs/VIC_Global_NH_NR_DP_S10_%j.err
...
echo "Starting VIC Global run: NH_NR_DP_S10"
...
CONFIG="/lustre/nobackup/WUR/ESG/smets008/mGV/validations/global/vic_global_config_NH_NR_DP_S10.txt"
...
ret=$?
echo "----------------------------------"
echo "VIC Global run finished with exit code: $ret"
echo "Time: $(date)"
exit $ret
