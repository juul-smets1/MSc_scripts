...
#SBATCH --output=/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/VIC-WUR_config_files/Strong_scaling_job_requests/Include_Cryosphere/logs/VIC_Global_ss_C_MPI16_OpenMP8_%j.out
#SBATCH --error=/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/VIC-WUR_config_files/Strong_scaling_job_requests/Include_Cryosphere/logs/VIC_Global_ss_C_MPI16_OpenMP8_%j.err
