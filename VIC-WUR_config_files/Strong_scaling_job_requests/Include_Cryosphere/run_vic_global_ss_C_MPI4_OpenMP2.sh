...
#SBATCH --output=/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/VIC-WUR_config_files/Strong_scaling_job_requests/Include_Cryosphere/logs/VIC_Global_ss_C_MPI4_OpenMP2_%j.out
#SBATCH --error=/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/VIC-WUR_config_files/Strong_scaling_job_requests/Include_Cryosphere/logs/VIC_Global_ss_C_MPI4_OpenMP2_%j.err
...
CONFIG="/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/VIC-WUR_config_files/Strong_scaling_job_requests/Include_Cryosphere/vic_global_ss_C_MPI4_OpenMP2_config.txt"
