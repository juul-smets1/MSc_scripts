#!/bin/bash
#SBATCH --job-name=VIC_NH_NR_DP_S5
#SBATCH --output=/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/VIC-WUR_config_files/logs/VIC_NH_NR_DP_S5_%j.out
#SBATCH --error=/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/VIC-WUR_config_files/logs/VIC_NH_NR_DP_S5_%j.err
...
echo "Starting VIC run: NH_NR_DP_S5"
...
CONFIG="/lustre/nobackup/WUR/ESG/smets008/mGV/validations/mekong/vic_mekong_config_NH_NR_DP_S5.txt"
