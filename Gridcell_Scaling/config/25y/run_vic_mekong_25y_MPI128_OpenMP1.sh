#!/bin/bash
#SBATCH --job-name=VIC_Mekong_gridcell_scaling
#SBATCH --output=/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/Gridcell_Scaling/logs/VIC_mekong_MPI128_OpenMP1_%j.out
#SBATCH --error=/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/Gridcell_Scaling/logs/VIC_mekong_MPI128_OpenMP1_%j.err
...
echo "Starting VIC mekong run: gridcell scalling"
...
CONFIG="/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/Gridcell_Scaling/config/25y/vic_mekong_25y_config.txt"
...
ret=$?
echo "--------------------------------------------------------------------"
echo "VIC mekong gridcell scaling run finished with exit code: $ret"
echo "Time: $(date)"
exit $ret
