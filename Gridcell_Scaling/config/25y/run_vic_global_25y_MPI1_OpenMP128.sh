...
#SBATCH --output=/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/Gridcell_Scaling/logs/VIC_global_MPI1_OpenMP128_%j.out
#SBATCH --error=/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/Gridcell_Scaling/logs/VIC_global_MPI1_OpenMP128_%j.err
...
CONFIG="/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/Gridcell_Scaling/config/25y/vic_global_OpenMP_25y_config.txt"
