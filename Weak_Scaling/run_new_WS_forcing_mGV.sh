#!/usr/bin/env bash
#SBATCH --job-name=Create_WS_mGV_Forcing_Data
...
#SBATCH --output=/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/Weak_Scaling/logs/new_WS_forcing_mGV_%j.out
#SBATCH --error=/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/Weak_Scaling/logs/new_WS_forcing_mGV_%j.err
