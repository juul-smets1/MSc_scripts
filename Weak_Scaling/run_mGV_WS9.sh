...
#SBATCH --output=/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/Weak_Scaling/logs/mGV_WS9_%j.out
#SBATCH --error=/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/Weak_Scaling/logs/mGV_WS9_%j.err

echo "=================================================================================="
echo "   Starting mGV run: zarr output implementation gitbranch for mGV Weak Scaling 9"
