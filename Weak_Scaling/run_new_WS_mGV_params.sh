#!/usr/bin/env bash
#SBATCH --job-name=Create_WS_mGV_Parameters
...
#SBATCH --output=/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/Weak_Scaling/logs/new_WS_mGV_params_%j.out
#SBATCH --error=/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/Weak_Scaling/logs/new_WS_mGV_params_%j.err
