...
#SBATCH --output=/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/Weak_Scaling/logs/make_WS_masks_domain_%j.out
#SBATCH --error=/lustre/nobackup/WUR/ESG/smets008/temporary/MSc_scripts/Weak_Scaling/logs/make_WS_masks_domain_%j.err
...
python make_WS_masks_domain.py
