# ============================================================
# Script: extract_modis_aqua_LST_ET_PET_combined_timeseries.py
# Purpose:
...
# ============================================================
# 2. Define MODIS grid geometries
# ============================================================
grid_geometries = {
    "h28v08": [
        (99.6259, 0.0004),
...
def compute_lat_lon(boundary_points, n_rows, n_cols):
    """Vectorized bilinear interpolation for MODIS tile lat/lon."""
...
# ============================================================
# 4. Spatial filter for VIC boundary
# ============================================================
...
def main():
    ...
    # Base directories
    # ----------------------------
    lst_dir = r"D:\WUR\NASA_ESDS\MODISAqua_Mekong_LST&E_Data_F19"
    et_pet_dir = r"D:\WUR\NASA_ESDS\MODISAqua_MekongETData_F19"

    output_csv = r"D:\WUR\NASA_ESDS\MODIS_Aqua_LST_ET_PET_timeseries.csv"
    ...
    print(f"✅ Combined MODIS Aqua LST–ET–PET time series saved to:\n{output_csv}")
