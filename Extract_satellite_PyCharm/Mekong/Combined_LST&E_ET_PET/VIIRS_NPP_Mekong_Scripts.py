# ============================================================
# Script: extract_viirs_LST_ET_PET_combined_timeseries.py
# Purpose:
...
# ============================================================
# 2. VIIRS tile grid geometries (same as MODIS h28v07, h28v08)
# ============================================================
grid_geometries = {
    "h28v08": [
        (99.6259, 0.0004),
...
def main():
    ...
    # Base directories
    # ----------------------------
    lst_dir = r"D:\WUR\NASA_ESDS\VIIRS_NPP_Mekong_LST&E_Data_F19"
    et_pet_dir = r"D:\WUR\NASA_ESDS\VIIRS_NPP_MekongETData_F19"

    output_csv = os.path.join(lst_dir, "VIIRS_NPP_LST_ET_PET_timeseries.csv")
