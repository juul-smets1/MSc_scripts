...
def main():
    ...
    base_dir = r"D:\WUR\NASA_ESDS\MODISTerra_Mekong_LST&E_Data_F19"
    output_csv = os.path.join(base_dir, "MODIS_LST_timeseries.csv")
    ...
    print(f"\n✅ Saved MODIS LST time series to {output_csv}")
