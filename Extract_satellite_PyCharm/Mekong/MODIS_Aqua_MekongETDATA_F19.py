# ============================================================
# Script: extract_modis_aqua_et_timeseries_netCDF.py
# Purpose: Loop through MODIS Aqua ET_500m HDF files across years
...
# -------------------------------
# 4. Load ET_500m dataset from MODIS HDF4 via netCDF4
# -------------------------------
def load_et_data(file_path):
    """Load ET_500m dataset from MODIS Aqua HDF4 using netCDF4."""
    with Dataset(file_path, mode='r') as hdf:
        # ET dataset is typically named 'ET_500m' in MYD16A2GF files
        data = hdf.variables['ET_500m'][:]
...
def extract_date_from_filename(filename):
    ...
    Works correctly even when year changes (e.g., 2002361 -> 2002-12-27).
    """
...
# -------------------------------
def main():
    base_dir = r"D:\WUR\NASA_ESDS\MODISAqua_MekongETData_F19"
    output_csv = os.path.join(base_dir, "MODIS_Aqua_ET_timeseries.csv")
    ...
    print(f"\n✅ Saved MODIS Aqua ET time series to {output_csv}")
