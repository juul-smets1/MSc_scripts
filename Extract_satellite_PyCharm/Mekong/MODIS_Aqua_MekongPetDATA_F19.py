# ============================================================
# Script: extract_modis_aqua_pet_timeseries_netCDF.py
# Purpose: Loop through MODIS Aqua PET_500m HDF files across years
...
def load_pet_data(file_path):
    """Load PET_500m dataset from MODIS Aqua HDF4 using netCDF4."""
    with Dataset(file_path, mode='r') as hdf:
        # PET dataset is typically named 'PET_500m' in MYD16A2GF files
...
def main():
    ...
    output_csv = os.path.join(base_dir, "MODIS_Aqua_PET_timeseries.csv")
    ...
    print(f"\n✅ Saved MODIS Aqua PET time series to {output_csv}")
