# ============================================================
# Script: extract_viirs_pet_timeseries.py
# Purpose: Loop through VIIRS PET_500m HDF5 files across years
...
# -------------------------------
# 4. Load PET_500m dataset from HDF5
# -------------------------------
def load_pet_data(file_path):
    """Load PET_500m dataset from HDF5 file."""
    dataset_path = '/HDFEOS/GRIDS/VIIRS_Grid_ETLE/Data Fields/PET_500m'
...
# -------------------------------
def main():
    base_dir = r"D:\WUR\NASA_ESDS\VIIRS_NPP_MekongETDATA"
    output_csv = os.path.join(base_dir, "VIIRS_PET_timeseries.csv")
