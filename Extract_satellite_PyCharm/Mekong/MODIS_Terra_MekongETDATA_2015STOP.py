# ============================================================
# Script: extract_modis_et_timeseries_netCDF.py
# Purpose: Loop through MODIS Terra ET_500m HDF files across years
...
def load_et_data(file_path):
    """Load ET_500m dataset from MODIS HDF4 file using netCDF4."""
    with Dataset(file_path, mode='r') as hdf:
        # ET dataset is typically named 'ET_500m'
...
# -------------------------------
def main():
    base_dir = r"D:\WUR\NASA_ESDS\MODIS_Terra_MekongETDATA"
    output_csv = os.path.join(base_dir, "MODIS_ET_timeseries.csv")
    ...
    print(f"\n✅ Saved MODIS Terra ET time series to {output_csv}")
