# ============================================================
# Script: extract_viirs_LST_ET_PET_Yucatan_timeseries.py
# Purpose:
# - Loop through VIIRS NPP LST (VNP21A2 Collection 2), ET/PET HDF5 files
# - Handle multiple granules per date (Yucatán tiles: h09v06, h09v07)
# - Clip to Yucatán VIC boundary
...
# ============================================================
# 1. VIC boundary — Yucatán Peninsula (Mexico, Belize, Guatemala)
# ============================================================
vic_boundary = {
    "lat_min": 16.0,
    "lat_max": 21.7,
...
# ============================================================
# 2. VIIRS granule geometries (Yucatán tiles)
# ============================================================
granule_geometries = {
    "h09v06": [
        (-95.7583, 19.8939),
...
# ============================================================
# 6. Load VIIRS variable (fixed for VNP21A2 Collection 2 structure)
# ============================================================
def load_viirs_variable(file_path, product):
    """
    Load LST_Day_1KM, ET_500m or PET_500m using h5py.
    LST path (Collection 2): /HDFEOS/GRIDS/VIIRS_Grid_8Day_1km_LST21/Data Fields/LST_Day_1KM
...
def main():
    ...
    out_csv = r"D:\WUR\NASA_ESDS\Yucatán\VIIRS_NPP_LST_ET_PET_timeseries.csv"
    ...
    print(f"✅ Saved VIIRS Yucatán LST–ET–PET time series to:\n{out_csv}")
