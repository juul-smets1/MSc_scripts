# ============================================================
# Script: extract_modis_terra_LST_ET_PET_BKJ_timeseries.py
# Purpose:
...
# ============================================================
# 2. MODIS tile grid geometries — LST&E and ET granules
# ============================================================
grid_geometries = {
    # LST&E granule
    "h29v08_lst": [
...
# ============================================================
# 6. Load MODIS variable with warning
# ============================================================
...
def process_product_for_date(files, base_dir, product, valid_mask_func):
    ...
    # Assign proper grid geometry key and variable name
    if product == "LST":
        grid_key = "h29v08_lst"
    ...
    matches = [f for f in files if f.endswith(".hdf") and "h29v08" in f]
    if not matches:
        print(f"⚠ WARNING: No matching files for {product} in directory {base_dir}")
        return np.nan
    ...
    # Compute lat/lon for the correct granule
...
# ============================================================
def main():
    lst_dir = r"D:\WUR\NASA_ESDS\BKJ\MODISTerra_BKJ_LSurfT_Data"
    et_pet_dir = r"D:\WUR\NASA_ESDS\BKJ\MODISTerra_BKJ_ETData"
    output_csv = r"D:\WUR\NASA_ESDS\BKJ\MODIS_Terra_BKJ_LST_ET_PET_timeseries.csv"
