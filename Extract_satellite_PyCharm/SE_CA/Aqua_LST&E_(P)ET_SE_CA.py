# ============================================================
# Script: extract_modis_aqua_LST_ET_PET_SECA_timeseries_safe.py
# Purpose:
...
#   - Flag corrupt/missing files without crashing
# ============================================================
...
def main():
    ...
    # Directories
    # ----------------------------
    lst_dir = r"D:\WUR\NASA_ESDS\SE_CA\MODISAqua_SECA_LSurfT_Data"
    et_pet_dir = r"D:\WUR\NASA_ESDS\SE_CA\MODISAqua_SECA_ETData"
    output_csv = r"D:\WUR\NASA_ESDS\SE_CA\MODIS_Aqua_LST_ET_PET_SECA.csv"
